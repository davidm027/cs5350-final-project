...
namespace
{
    ...
    bool find_first_empty(const Sudoku& input, int& row, int& col)
    {
        for (int r = 0; r < 9; r++)
        {
            for (int c = 0; c < 9; c++)
    ...
    bool find_best_empty_mrv(const Sudoku& input, int& best_row, int& best_col)
    {
        int best_count = 10;
    ...
    bool advanced_serial_mrv(Sudoku& input)
    {
        int row = 0;
        int col = 0;
    ...
    bool advanced_openmp_mrv(Sudoku& input)
    {
        int row = 0;
        int col = 0;
        ...
        for (int choice = 1; choice <= 9; choice++)
        {
            if (input.is_choice_valid(row, col, choice))
            {
                ...
                if (advanced_serial_mrv(current))
                {
                    solutions[choice] = current;
                    found[choice] = true;
                }
